        ...
        match (profile, path.replace("\\", "/").as_str()) {
            (Profile::Release, "examples/intrinsics") => Some((
                &[
                    ...
                    "tail call signext i32 @llvm.nvvm.read.ptx.sreg.ctaid.y()",
                    "tail call signext i32 @llvm.nvvm.read.ptx.sreg.tid.y()",
                    "tail call signext i32 @llvm.nvvm.read.ptx.sreg.ntid.x()",
                    "tail call signext i32 @llvm.nvvm.read.ptx.sreg.ctaid.x()",
            ...
            (Profile::Debug, "examples/intrinsics") => Some((
                &[
                    "call signext i32 @llvm.nvvm.read.ptx.sreg.ntid.y()",
                    "call signext i32 @llvm.nvvm.read.ptx.sreg.ctaid.y()",
                    "call signext i32 @llvm.nvvm.read.ptx.sreg.tid.y()",
